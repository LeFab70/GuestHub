 ...
 */
router.post('/', authRateLimit, ...departmentValidations.create, departmentController.createDepartment);
 ...
 *         description: Erreur serveur
 */
router.put('/:id', ...departmentValidations.update, departmentController.updateDepartment);
